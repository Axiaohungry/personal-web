...
export const foodMealTemplates = {
  cut: [
    '训练前 2 小时：米饭 + 鸡胸 + 一份水果，训练后补低脂酸奶或乳清。',
    '休息日：瘦牛肉 + 双份蔬菜 + 少量根茎类碳水，把饱腹感做起来。',
    '如果晚间容易饿，优先加蔬菜、蘑菇、无糖酸奶，而不是甜食或烘焙。',
  ],
  gain: [
    '高容量训练日：米饭 / 意面 + 鸡胸或牛肉 + 一份水果，训练后再补一餐主食。',
    '早餐优先燕麦、酸奶、鸡蛋，减少白天补不够碳水的压力。',
    '休息日不需要把碳水拉满，但也不要因为“休息”直接吃成低碳。',
  ],
}
